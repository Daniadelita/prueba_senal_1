...
public class SKAPreferenceActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener{
	...
	protected void updateLabels(){
		...
		app.saveLong(SKConstants.PREF_DATA_CAP, 50);
		long configDataCap = app.getLong(SKConstants.PREF_DATA_CAP,-11);
		System.out.println("jdsgxbytfdegdbaegd6agda: " + configDataCap);
